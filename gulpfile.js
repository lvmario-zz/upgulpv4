...
var gulp = require( 'gulp' ),
	 ...
	 */
	moduleRoot = require( 'app-root-path' ).resolve( './' ).replace(/\\/g,"/"), //double backslash not works in watch task
	/**
...
gulp.task( 'default', gulp.series('sprites', 'i18n', 'icons', 'styles', 'scripts', 'imagemin' ));
